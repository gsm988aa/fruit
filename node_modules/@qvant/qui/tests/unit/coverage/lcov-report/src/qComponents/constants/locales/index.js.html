...
<head>
    <title>Code coverage report for src/qComponents/constants/locales/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/qComponents/constants/locales</a> index.js</h1>
        <div class='clearfix'>
...
const installI18n = ({ locale, customI18nMessages }) =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isI18nExist) {
