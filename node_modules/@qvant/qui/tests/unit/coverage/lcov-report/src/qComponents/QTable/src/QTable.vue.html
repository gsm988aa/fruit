...
<head>
    <title>Code coverage report for src/qComponents/QTable/src/QTable.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/qComponents/QTable/src</a> QTable.vue</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">27.31% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>65/238</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">23.88% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>48/201</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">44.87% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>35/78</span>
            </div>
...
&nbsp;
  props: {
    ...
    selectableColumn: {
      ...
      required: false,
      validator: props =&gt; {
<span class="missing-if-branch" title="else path not taken" >E</span>        if (!Object.keys(props).length) return true;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return this.checkedRows.length === this.rows.length;</span>
      },
<span class="fstat-no" title="function not covered" >      set(isChecked) {</span>
<span class="cstat-no" title="statement not covered" >        this.checkedRows = isChecked</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    isIndeterminate() {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    tableClass() {</span>
<span class="cstat-no" title="statement not covered" >      if (this.scrolled === 0) return 'scrolled-left';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const QTableWidth = this.$refs.QTable.offsetWidth;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.scrolled === QTableWidth - this.wrapperWidth</span>
        ? 'scrolled-right'
        : 'scrolled-center';
    },
&nbsp;
    computedRows() {
<span class="branch-1 cbranch-no" title="branch not covered" >      const rows = this.treeRows.length ? this.treeRows : this.rows;</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    checkboxColWidth() {</span>
<span class="cstat-no" title="statement not covered" >      return { width: `${CHECKBOX_COL_WIDTH}px` };</span>
    }
  },
&nbsp;
  watch: {
<span class="fstat-no" title="function not covered" >    isLoading() {</span>
<span class="cstat-no" title="statement not covered" >      this.isLoadingAnimationComplete = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      setTimeout(() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        this.loaderWrapperHeight = this.$refs.QTable</span>
          ? this.$refs.QTable.clientHeight + shadowDropOffset
          : MIN_BLANK_TABLE_HEIGHT;
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >        setTimeout(() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >          this.isLoadingAnimationComplete = true;</span>
        }, 200);
      }, this.timer * 300);
    },
    rows: {
...
<span class="cstat-no" title="statement not covered" >            updatedRow.data[this.childrenKey] = this.updateChildrenRows(</span>
              childs,
              row,
              updatedRow
            );
...
<span class="fstat-no" title="function not covered" >    checkedRows(rowsIndexes) {</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      const rows = this.computedRows.filter((_, index) =&gt;</span></span>
        rowsIndexes.includes(index)
      );
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.$emit('rows-check', rows);</span>
    }
  },
&nbsp;
  updated() {
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>    if (!this.QFirstRowEl) return;
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.getStickedOffsets();</span>
<span class="cstat-no" title="statement not covered" >    this.createObservers();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.isRendered) this.detectIntersections(0);</span>
  },
&nbsp;
  created() {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  destroyed() {</span>
<span class="cstat-no" title="statement not covered" >    window.removeEventListener('resize', this.changeWrapperHeight);</span>
  },
&nbsp;
  mounted() {
<span class="missing-if-branch" title="else path not taken" >E</span>    if (this.$refs.QTable) {
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>    if (wrapper &amp;&amp; this.$refs.QTable) {
<span class="missing-if-branch" title="if path not taken" >I</span>      if (wrapper.offsetWidth &lt; this.$refs.QTable.offsetWidth) {
<span class="cstat-no" title="statement not covered" >        this.wrapperClass = 'q-table__wrapper_scrollable';</span>
      }
&nbsp;
...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>    if (!this.$refs.scrollbar) return;
&nbsp;
    this.$watch(
...
&nbsp;
<span class="fstat-no" title="function not covered" >  beforeDestroy() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.$refs.tableWrapper) return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.$refs.tableWrapper.removeEventListener('scroll', this.onScroll);</span>
  },
&nbsp;
  methods: {
<span class="fstat-no" title="function not covered" >    createObservers() {</span>
<span class="cstat-no" title="statement not covered" >      if (!this.$refs.QTable) return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.observers = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      let totalWidth = parseFloat(</span>
...
<span class="cstat-no" title="statement not covered" >        if (this.isSelectableColumnSticked) {</span>
<span class="cstat-no" title="statement not covered" >          this.observers['q-table-checkboxes'] = {</span>
            position: 'left',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        totalWidth += CHECKBOX_COL_WIDTH;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      this.allColumns.forEach(({ sticky, key }, index) =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        const elementWidth = this.QFirstRowEl.querySelector(</span>
          `td:nth-child(${index + (this.isSelectable ? 2 : 1)})`
        ).offsetWidth;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!sticky) {</span>
<span class="cstat-no" title="statement not covered" >          totalWidth += elementWidth;</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.observers[key] = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      totalWidth += parseFloat(</span>
        window.getComputedStyle(this.$refs.tableWrapper).paddingRight
      );
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    detectIntersections(moveX) {</span>
<span class="cstat-no" title="statement not covered" >      const rootWidth = this.$refs.root.offsetWidth;</span>
<span class="cstat-no" title="statement not covered" >      const moveXPixels = (rootWidth * moveX) / 100;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!this.$refs.QTable) return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const observers = { ...this.observers };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      Object.entries(observers).forEach(</span></span>
        (
          [key, { position, triggerLeft, triggerRight, offset, isSticked }],
          index
        ) =&gt; {
<span class="cstat-no" title="statement not covered" >          const intersectableElements = this.$refs.QTable.querySelectorAll(</span>
            `[observer-key=${key}]`
          );
&nbsp;
<span class="cstat-no" title="statement not covered" >          const scroll = moveXPixels + offset;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          let triggerWithinRoot = triggerLeft &lt; scroll;</span>
<span class="cstat-no" title="statement not covered" >          let triggerOutsideRoot = triggerLeft &gt;= scroll;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (position === 'right') {</span>
<span class="cstat-no" title="statement not covered" >            const reversedOffset = triggerRight + offset * 2;</span>
<span class="cstat-no" title="statement not covered" >            triggerWithinRoot = reversedOffset &gt; scroll + rootWidth;</span>
<span class="cstat-no" title="statement not covered" >            triggerOutsideRoot = reversedOffset &lt; scroll + rootWidth;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          const isTriggerConditionChanged =</span>
            (!isSticked &amp;&amp; triggerWithinRoot) ||
            (isSticked &amp;&amp; triggerOutsideRoot);
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!isTriggerConditionChanged) return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          observers[key].isSticked = !isSticked &amp;&amp; triggerWithinRoot;</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >          intersectableElements.forEach(elem =&gt;</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.observers = observers;</span>
<span class="cstat-no" title="statement not covered" >      this.isRendered = true;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    changeStickyStyles({ elem, index, position, isOff, offset }) {</span>
<span class="cstat-no" title="statement not covered" >      if (isOff) {</span>
<span class="cstat-no" title="statement not covered" >        elem.classList.remove('q-table__sticked-cell');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (position === 'right') {</span>
<span class="cstat-no" title="statement not covered" >          elem.classList.remove('q-table__sticked-cell_is-reversed');</span>
          /* eslint-disable-next-line no-param-reassign */
<span class="cstat-no" title="statement not covered" >          elem.style.zIndex = null;</span>
        }
&nbsp;
        /* eslint-disable-next-line no-param-reassign */
<span class="cstat-no" title="statement not covered" >        elem.style[position] = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      elem.classList.add('q-table__sticked-cell');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      let correction = this.grid ? index : 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (position === 'right') {</span>
<span class="cstat-no" title="statement not covered" >        const reversedIndex =</span>
          Object.keys(this.stickedOffsets.right).length + 2 - index;
&nbsp;
<span class="cstat-no" title="statement not covered" >        elem.classList.add('q-table__sticked-cell_is-reversed');</span>
        /* eslint-disable-next-line no-param-reassign */
<span class="cstat-no" title="statement not covered" >        elem.style.zIndex = reversedIndex;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        correction = this.grid ? reversedIndex : 0;</span>
      }
&nbsp;
      /* eslint-disable-next-line no-param-reassign */
<span class="cstat-no" title="statement not covered" >      elem.style[position] = `${offset + correction}px`;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    getStickyOffset(position, key) {</span>
<span class="cstat-no" title="statement not covered" >      if (!Object.keys(this.stickedOffsets[position]).length) return 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.stickedOffsets[position]?.[key] ?? 0;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    getStickedOffsets() {</span>
<span class="cstat-no" title="statement not covered" >      if (!this.$refs.QTable) return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.stickedOffsets = {</span>
        left: {},
        right: {}
      };
&nbsp;
<span class="cstat-no" title="statement not covered" >      let tds = this.QFirstRowEl.querySelectorAll('td');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!tds.length) return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      let totalLeftWidth = 0;</span>
<span class="cstat-no" title="statement not covered" >      let totalRightWidth = 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.isSelectable &amp;&amp; this.isSelectableColumnSticked) {</span>
<span class="cstat-no" title="statement not covered" >        this.stickedOffsets.left['q-table-checkboxes'] = CHECKBOX_COL_WIDTH;</span>
<span class="cstat-no" title="statement not covered" >        totalLeftWidth += CHECKBOX_COL_WIDTH;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      this.allColumns.forEach((col, index) =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        if (col.sticky?.position === 'left') {</span>
<span class="cstat-no" title="statement not covered" >          this.stickedOffsets.left[col.key] = totalLeftWidth;</span>
<span class="cstat-no" title="statement not covered" >          totalLeftWidth += tds[index].offsetWidth;</span>
        }
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      tds = Array.from(tds).reverse();</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      [...this.allColumns].reverse().forEach((col, index) =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        if (col.sticky?.position === 'right') {</span>
<span class="cstat-no" title="statement not covered" >          this.stickedOffsets.right[col.key] = totalRightWidth;</span>
<span class="cstat-no" title="statement not covered" >          totalRightWidth += tds[index].offsetWidth;</span>
        }
      });
    },
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >      return hasSlot ? null : 'q-table__header-cell-content_original';</span>
    },
&nbsp;
    getHeaderTitle({ value, slots }) {
      const hasSlot = Boolean(slots?.header || this.$scopedSlots.header);
<span class="branch-0 cbranch-no" title="branch not covered" >      return hasSlot ? null : value;</span>
    },
&nbsp;
    changeWrapperHeight() {
      if (this.isLoading || !this.isLoadingAnimationComplete) return;
&nbsp;
<span class="branch-1 cbranch-no" title="branch not covered" >      this.loaderWrapperHeight = this.$refs.QTable</span>
        ? this.$refs.QTable.clientHeight + shadowDropOffset
        : MIN_BLANK_TABLE_HEIGHT;
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    updateChildrenRows(childs, row, updatedRow) {</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      return childs.map(child =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        const childlessRow = { ...row };</span>
<span class="cstat-no" title="statement not covered" >        this.$delete(childlessRow, [this.childrenKey]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        const updatedChildRow = {</span>
          data: child,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        const rowChilds = updatedChildRow.data[this.childrenKey];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (rowChilds) {</span>
<span class="cstat-no" title="statement not covered" >          updatedChildRow.data[this.childrenKey] = this.updateChildrenRows(</span>
            rowChilds,
            child,
            updatedChildRow
          );
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return updatedChildRow;</span>
      });
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    handleHeaderClick({ key, sortable }) {</span>
<span class="cstat-no" title="statement not covered" >      if (!sortable) return;</span>
<span class="cstat-no" title="statement not covered" >      this.setSort(key);</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    getHandlerClass(group) {</span>
<span class="cstat-no" title="statement not covered" >      return `${this.isSeparated ? group : 'column'}-handler`;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    findSlotForRow(columnKey) {</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      const currentCol = this.allColumns.find(({ key }) =&gt; key === columnKey);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return currentCol?.slots?.row ?? null;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    handleRowClick(row) {</span>
<span class="cstat-no" title="statement not covered" >      this.$emit('row-click', row);</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    handleRowCheck({ isChecked, rowIndex }) {</span>
<span class="cstat-no" title="statement not covered" >      const checkedRows = new Set(this.checkedRows);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isChecked) {</span>
<span class="cstat-no" title="statement not covered" >        checkedRows.add(rowIndex);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        checkedRows.delete(rowIndex);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.checkedRows = Array.from(checkedRows);</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    setSort(key, direction) {</span>
<span class="cstat-no" title="statement not covered" >      if (direction) {</span>
<span class="cstat-no" title="statement not covered" >        this.sort = {</span>
          key,
          direction
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.$emit('change-sort', this.sort);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.sort.key !== key) {</span>
<span class="cstat-no" title="statement not covered" >        this.sort = {</span>
          key,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      switch (this.sort.direction) {</span>
        case null:
<span class="cstat-no" title="statement not covered" >          this.sort.direction = 'ascending';</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        case 'ascending':
<span class="cstat-no" title="statement not covered" >          this.sort.direction = 'descending';</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        default:
        case 'descending':
<span class="cstat-no" title="statement not covered" >          this.sort.direction = null;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.$emit('change-sort', this.sort);</span>
...
&nbsp;
    levelClass(indent) {
<span class="missing-if-branch" title="else path not taken" >E</span>      if (!indent) return '';
<span class="cstat-no" title="statement not covered" >      return `q-table__row-level-${indent / this.indentSize}`;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    handleExpandClick(row) {</span>
<span class="cstat-no" title="statement not covered" >      const currentRow = this.treeRows[row.treeIndex];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!row.isTreeOpened) {</span>
<span class="cstat-no" title="statement not covered" >        const updatedRow = {</span>
          ...currentRow,
          isTreeOpened: true
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.treeRows.splice(currentRow, 1, updatedRow);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.$delete(currentRow, 'isTreeOpened');</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    findScopedRow(row, key, value) {</span>
<span class="cstat-no" title="statement not covered" >      let foundRow = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (row[key] === value) {</span>
<span class="cstat-no" title="statement not covered" >        foundRow = row;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!foundRow &amp;&amp; row[this.childrenKey]) {</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >        row[this.childrenKey].forEach(childRow =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >          if (!foundRow) foundRow = this.findScopedRow(childRow, key, value);</span>
        });
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return foundRow;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    resolve(row, newChilds, isAdditional) {</span>
<span class="cstat-no" title="statement not covered" >      this.treeRows = this.computedRows;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const parentRow = this.findScopedRow(</span>
        this.treeRows[row.treeIndex],
        this.uniqueKey,
        row[this.uniqueKey]
      );
&nbsp;
<span class="cstat-no" title="statement not covered" >      let loaderRow = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      let updatedChilds = newChilds.map(child =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        const childlessRow = { ...row };</span>
<span class="cstat-no" title="statement not covered" >        this.$delete(childlessRow, [this.childrenKey]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (child[this.pagesInExpand]) {</span>
<span class="cstat-no" title="statement not covered" >          loaderRow = { ...child, parentRow: childlessRow };</span>
        }
<span class="cstat-no" title="statement not covered" >        return {</span>
          ...child,
          parentRow: childlessRow,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.pagesInExpand &amp;&amp; loaderRow) {</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >        updatedChilds = updatedChilds.filter(</span></span>
          child =&gt; !child[this.pagesInExpand]
        );
<span class="cstat-no" title="statement not covered" >        updatedChilds.push(loaderRow);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isAdditional &amp;&amp; parentRow[this.childrenKey]) {</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >        const childs = parentRow[this.childrenKey].filter(</span></span>
          child =&gt; !child[this.pagesInExpand]
        );
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.$set(parentRow, [this.childrenKey], [...childs, ...updatedChilds]);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this.$set(parentRow, [this.childrenKey], updatedChilds);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      parentRow.isTreeOpened = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.treeRows;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    onScroll({ target }) {</span>
<span class="cstat-no" title="statement not covered" >      this.scrolled = target.scrollLeft;</span>
    },
&nbsp;
    getHeaderCellStyles(group, column) {
      const style = {};
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>      if (column?.minWidth) style.minWidth = column.minWidth;
<span class="missing-if-branch" title="else path not taken" >E</span>      if (!this.isSeparated || !group) return style;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return {</span>
        ...style,
...
&nbsp;
<span class="branch-0 cbranch-no" title="branch not covered" >    getCellClasses(column = {}, group) {</span>
      const classes = [this.getSortableClass(column)];
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>      if (this.isSeparated) {
<span class="cstat-no" title="statement not covered" >        classes.push(`q-table__header-cell_${group.key}`);</span>
      }
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>      if (group.align || column.align) {
<span class="cstat-no" title="statement not covered" >        classes.push(</span>
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>      if (!isColumnSortable) return '';
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.sort.key === column?.key) {</span>
<span class="cstat-no" title="statement not covered" >        return `${sortableClass} ${sortableClass}`;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return sortableClass;</span>
    },
&nbsp;
    getColWidth(column) {
      return {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    updateColumnItem(item, index, key) {</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
        columnKey: key || null,
        index,
...
&nbsp;
<span class="fstat-no" title="function not covered" >    updateTotalItem(item, index, key) {</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
        columnKey: key || null,
        index,
        value: item[key] ?? null
...
&nbsp;
<span class="fstat-no" title="function not covered" >    changeColumnsOrder({ newPositionIndex, oldPositionIndex }, groupKey) {</span>
<span class="cstat-no" title="statement not covered" >      const columns = cloneDeep(this.groupsOfColumns);</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      const group = columns.find(({ key }) =&gt; key === groupKey);</span></span>
<span class="cstat-no" title="statement not covered" >      if (group?.columns) {</span>
<span class="cstat-no" title="statement not covered" >        group.columns.splice(</span>
          newPositionIndex,
          0,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.$emit('change-order', columns);</span>
    }
  }
};
&lt;/script&gt;
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Mar 30 2021 13:04:15 GMT+0300 (Moscow Standard Time)
            </div>
        </div>
