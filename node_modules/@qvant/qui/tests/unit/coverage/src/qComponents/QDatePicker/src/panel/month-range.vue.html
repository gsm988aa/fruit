...
<head>
    <title>Code coverage report for src/qComponents/QDatePicker/src/panel/month-range.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">src/qComponents/QDatePicker/src/panel</a> month-range.vue</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        return this.rightDate.getFullYear() === this.leftDate.getFullYear()</span>
          ? this.leftDate.getFullYear() + 1
          : this.rightDate.getFullYear();
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return new Date().getFullYear() + 1;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    enableYearArrow() {</span>
<span class="cstat-no" title="statement not covered" >      return this.rightYear &gt; this.leftYear + 1;</span>
    }
  },
&nbsp;
  methods: {
...
<span class="cstat-no" title="statement not covered" >      this.rightDate = addYears(new Date(), 1);</span>
